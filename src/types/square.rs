...
impl Square {
    ...
    pub const fn indices(self) -> (usize, usize) {
        ...
        match self {
            A1 => (0, 0), A2 => (0, 3), A3 => (0, 6),
            B1 => (0, 1), B2 => (0, 4), B3 => (0, 7),
            C1 => (0, 2), C2 => (0, 5), C3 => (0, 8),
            D1 => (1, 0), D2 => (1, 3), D3 => (1, 6),
            E1 => (1, 1), E2 => (1, 4), E3 => (1, 7),
            F1 => (1, 2), F2 => (1, 5), F3 => (1, 8),
            G1 => (2, 0), G2 => (2, 3), G3 => (2, 6),
            H1 => (2, 1), H2 => (2, 4), H3 => (2, 7),
            I1 => (2, 2), I2 => (2, 5), I3 => (2, 8),

            A4 => (3, 0), A5 => (3, 3), A6 => (3, 6),
            B4 => (3, 1), B5 => (3, 4), B6 => (3, 7),
            C4 => (3, 2), C5 => (3, 5), C6 => (3, 8),
            D4 => (4, 0), D5 => (4, 3), D6 => (4, 6),
            E4 => (4, 1), E5 => (4, 4), E6 => (4, 7),
            F4 => (4, 2), F5 => (4, 5), F6 => (4, 8),
            G4 => (5, 0), G5 => (5, 3), G6 => (5, 6),
            H4 => (5, 1), H5 => (5, 4), H6 => (5, 7),
            I4 => (5, 2), I5 => (5, 5), I6 => (5, 8),

            A7 => (6, 0), A8 => (6, 3), A9 => (6, 6),
            B7 => (6, 1), B8 => (6, 4), B9 => (6, 7),
            C7 => (6, 2), C8 => (6, 5), C9 => (6, 8),
            D7 => (7, 0), D8 => (7, 3), D9 => (7, 6),
            E7 => (7, 1), E8 => (7, 4), E9 => (7, 7),
            F7 => (7, 2), F8 => (7, 5), F9 => (7, 8),
            G7 => (8, 0), G8 => (8, 3), G9 => (8, 6),
            H7 => (8, 1), H8 => (8, 4), H9 => (8, 7),
            I7 => (8, 2), I8 => (8, 5), I9 => (8, 8),
        }
    }
